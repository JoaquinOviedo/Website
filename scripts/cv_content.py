...
CV = {
    "es": {
        ...
        "summary": (
            ...
            "entrega, y participo directamente en el desarrollo cuando la solución lo requiere."
        ),
        "experience": {
            ...
            "bullets": [
                "Gestiono y desarrollo una aplicación corporativa transversal: relevo necesidades con la persona usuaria cliente y análisis funcional, evalúo viabilidad, estimo, priorizo y distribuyo tareas.",
                ...
                "Administro roles y permisos en Dataverse, SharePoint y grupos AD corporativos, alineando accesos con las responsabilidades de cada perfil.",
        ...
        "projects": [
            {
                ...
                "bullets": [
                    "Desarrollé principalmente el backend del sistema: ASP.NET Core Web API sobre .NET 8, Entity Framework Core, JWT, SQL Server/PostgreSQL y OCR de Azure.",
                    "El equipo presentó WIRIN en la 23.ª JBDU y valida el producto con personal bibliotecario antes de implementarlo en la biblioteca de la UNLaM.",
                ],
            },
        ],
        "education": [
        ...
        "skills": [
            ("Power Platform", "Power Apps, Power Automate, Dataverse, SharePoint, tablas, variables de entorno, ambientes, pasajes a producción, roles y permisos"),
    ...
    "en": {
        ...
        "summary": (
            ...
            "and feasibility through prioritization, delegation, and delivery, while contributing "
            "directly to development when the solution requires it."
        ),
        "experience": {
            ...
            "bullets": [
                "Manage and develop a corporate application used across business areas: gather needs with the client user and functional analyst, assess feasibility, estimate, prioritize, and distribute work.",
                ...
                "Manage roles and permissions across Dataverse, SharePoint, and corporate AD groups, aligning access with each user profile's responsibilities.",
        ...
        "projects": [
            {
                ...
                "period": "2025 - Present",
                "bullets": [
                    "Developed mainly the system backend: ASP.NET Core Web API on .NET 8, Entity Framework Core, JWT, SQL Server/PostgreSQL, and Azure OCR.",
                    "The team presented WIRIN at the 23rd University Digital Library Conference and is validating it with library staff before implementation at UNLaM's library.",
                ],
            },
        ],
        "education": [
        ...
        "skills": [
            ("Power Platform", "Power Apps, Power Automate, Dataverse, SharePoint, tables, environment variables, environments, production releases, roles, and permissions"),
